...
$name=$_POST['name'];
$slug=$_POST['slug'];
$rows= xiu_exective("insert into categories values (null ,'{$slug}','{$name}');");
$GLOBALS['message']=$rows;
}
  

$categories=baixiu_fetch("select * from categories;");
        ...
        <div class="col-md-8">
          ...
          <table class="table table-striped table-bordered table-hover">
           ...
           <tr>
                ...
                <td class="text-center">
                  <a href="javascript:;" class="btn btn-info btn-xs">编辑</a>
                  <a href="category-delete.php?id=" class="btn btn-danger btn-xs" >删除</a>
                </td>
              </tr>
           <?php endforeach ?>
